...
}-3)){if(parseInt(e.pageOptions.index)==i){g+=' <span class="'+e.pageOptions.pageClass+'"><em class="'+e.pageOptions.emClass+'"></em><em>'+parseInt(i+1)+'</em></span>'}else{g+='<a  onclick="'+o+'.skipPage('+i+')">'+parseInt(i+1)+'</a>'}}else{}}}}else{if(parseInt(e.pageOptions.index)==i){g+=' <span class="'+e.pageOptions.pageClass+'"><em class="'+e.pageOptions.emClass+'"></em><em>'+parseInt(i+1)+'</em></span>'}else{g+='<a  onclick="'+o+'.skipPage('+i+')">'+parseInt(i+1)+'</a>'}}}if(count>1){if(e.pageOptions.index<=parseInt(count-2)){if(e.pageOptions.layout.indexOf('next')!=-1){g+='<a class="layui-laypage-next" onclick="'+o+'.nextPage();" >'+e.language.options.udNext+'</a>'}if(e.pageOptions.layout.indexOf('last')!=-1){g+='<a onclick="'+o+'.lastPage();" >'+e.language.options.udLast+'</a>'}}else{if(e.pageOptions.layout.indexOf('next')!=-1){g+='<a class="uiduck-page-disable">'+e.language.options.udNext+'</a>'}if(e.pageOptions.layout.indexOf('last')!=-1){g+='<a class="uiduck-page-disable" >'+e.language.options.udLast+'</a>'}}}if(e.pageOptions.layout.indexOf('total')!=-1){if(e.pageOptions.dataType=='back'){g+='<span>'+e.language.options.udTotal+' '+e.pageOptions.count+' '+e.language.options.udList+'</span>'}else{g+='<span>'+e.language.options.udTotal+' '+e.data.length+' '+e.language.options.udList+'</span>'}}if(e.pageOptions.layout.indexOf('set')!=-1){g+='<span class="uiduck-page-limits"><select id="ud-page-select" onchange="'+o+'.changeLimit(this.value)">';for(var j=0;j<e.pageOptions.limits.length;j++){if(e.pageOptions.limit==e.pageOptions.limits[j]){g+='<option value="'+e.pageOptions.limits[j]+'" selected="">'+e.pageOptions.limits[j]+' '+e.language.options.udList+'/'+e.language.options.udPage+'</option>'}else{g+='<option  value="'+e.pageOptions.limits[j]+'">'+e.pageOptions.limits[j]+' '+e.language.options.udList+'/'+e.language.options.udPage+'</option>'}}g+='</select></span>'}if(e.pageOptions.layout.indexOf('jump')!=-1){g+='<span class="uiduck-page-skip">'+e.language.options.udGo+'<input id="ud-page-skip-text" type="text" min="1" value="1" class="uiduck-page-input">'+e.language.options.udPage+'<button type="button" class="uiduck-page-btn" onclick="'+o+'.skipPage()">'+e.language.options.udSub+'</button></span>'}}else{uiduck.pageOptions.limit=10;var count=e.data.length/options.limit;if(e.data.length%options.limit!=0){count+=1}uiduck.pageOptions.count=count;if(e.pageOptions.index>0){if(e.pageOptions.layout.indexOf('home')!=-1){g+='<a onclick="'+o+'.firstPage();" >'+e.language.options.udHome+'</a>'}if(e.pageOptions.layout.indexOf('prev')!=-1){g+='<a onclick="'+o+'.prevPage();" >'+e.language.options.udPrev+'</a>'}}else{if(e.pageOptions.layout.indexOf('home')!=-1){g+='<a class="uiduck-page-disable" >'+e.language.options.udHome+'</a>'}if(e.pageOptions.layout.indexOf('prev')!=-1){g+='<a class="uiduck-page-disable">'+e.language.options.udPrev+'</a>'}}for(var i=0;i<count;i++){if(parseInt(e.pageOptions.index)==i){g+=' <span  class="'+e.pageOptions.pageClass+'"><em class="'+e.pageOptions.emClass+'"></em><em>'+parseInt(i+1)+'</em></span>'}else{g+='<a  onclick="'+o+'.skipPage('+i+')">'+parseInt(i+1)+'</a>'}}if(count>1){if(e.pageOptions.index<=parseInt(count-2)){if(e.pageOptions.layout.indexOf('next')!=-1){g+='<a class="layui-laypage-next" onclick="'+o+'.nextPage();" >'+e.language.options.udNext+'</a>'}if(e.pageOptions.layout.indexOf('last')!=-1){g+='<a onclick="'+o+'.lastPage();" >'+e.language.options.udLast+'</a>'}}else{if(e.pageOptions.layout.indexOf('next')!=-1){g+='<a class="uiduck-page-disable">'+e.language.options.udNext+'</a>'}if(e.pageOptions.layout.indexOf('last')!=-1){g+='<a class="uiduck-page-disable" >'+e.language.options.udLast+'</a>'}}}if(e.pageOptions.layout.indexOf('set')!=-1){g+='<span class="uiduck-page-limits"><select  id="ud-page-select"  onchange="'+o+'.changeLimit(this.value)">';for(var j=0;j<e.pageOptions.limits.length;j++){if(e.pageOptions.limit==e.pageOptions.limits[j]){g+='<option value="'+e.pageOptions.limits[j]+'" selected="">'+e.pageOptions.limits[j]+' '+e.language.options.udList+'/'+e.language.options.udPage+'</option>'}else{g+='<option value="'+e.pageOptions.limits[j]+'">'+e.pageOptions.limits[j]+' '+e.language.options.udList+'/'+e.language.options.udPage+'</option>'}}g+='</select></span>'}if(e.pageOptions.layout.indexOf('jump')!=-1){g+='<span class="layui-laypage-skip">'+e.language.options.udGo+'<input id="ud-page-skip-text" type="text" min="1" value="1" class="layui-input">'+e.language.options.udPrev+'<button type="button" class="layui-laypage-btn" onclick="uiduck.skipPage()">'+e.language.options.udSub+'</button></span>'}}if(e.autoNext.showPage==false){g=''}return g},nextPage:function(){if(!uiduck.autoNext){uiduck.pageOptions.index++;if(uiduck.url==false){uiduck.render(uiduck,false)}else{if(uiduck.pageOptions.dataType=='back'){uiduck.render(uiduck,true)}else if(uiduck.pageOptions.dataType=='front'){uiduck.render(uiduck,false)}}}else{if(uiduck.pageOptions.index==parseInt(uiduck.pageOptions.count-1)){uiduck.pageOptions.index=0;if(uiduck.url==false){uiduck.render(uiduck,false)}else{if(uiduck.pageOptions.dataType=='back'){uiduck.render(uiduck,true)}else if(uiduck.pageOptions.dataType=='front'){uiduck.render(uiduck,true)}}}else{uiduck.pageOptions.index++;if(uiduck.url==false){uiduck.render(uiduck,false)}else{if(uiduck.pageOptions.dataType=='back'){uiduck.render(uiduck,true)}else if(uiduck.pageOptions.dataType=='front'){uiduck.render(uiduck,false)}}}}},prevPage:function(){uiduck.pageOptions.index--;if(uiduck.url==false){uiduck.render(uiduck,false)}else{if(uiduck.pageOptions.dataType=='back'){uiduck.render(uiduck,true)}else if(uiduck.pageOptions.dataType=='front'){uiduck.render(uiduck,false)}}},firstPage:function(e){uiduck.pageOptions.index=0;if(uiduck.url==false){uiduck.render(uiduck,false)}else{if(uiduck.pageOptions.dataType=='back'){uiduck.render(uiduck,true)}else if(uiduck.pageOptions.dataType=='front'){uiduck.render(uiduck,false)}}},lastPage:function(){if(uiduck.url==false){var count=parseInt(uiduck.data.length/uiduck.pageOptions.limit);if(uiduck.data.length%uiduck.pageOptions.limit>0){count+=1}uiduck.pageOptions.index=count-1;uiduck.render(uiduck,false)}else{if(uiduck.pageOptions.dataType=='back'){var count=parseInt(uiduck.pageOptions.count/uiduck.pageOptions.limit);if(count%uiduck.pageOptions.limit>0){count+=1}uiduck.url.data={"pageSize":parseInt(uiduck.pageOptions.limit),"pageNum":count};uiduck.pageOptions.index=count-1 uiduck.getAjaxData(uiduck,false)}else if(uiduck.pageOptions.dataType=='front'){var count=parseInt(uiduck.data.length/uiduck.pageOptions.limit);if(uiduck.data.length%uiduck.pageOptions.limit>0){count+=1}uiduck.pageOptions.index=count-1;uiduck.render(uiduck,false)}}},skipPage:function(e){if(e==undefined){var index=parseInt($("#ud-page-skip-text").val());var reg=new RegExp("[0-9]+");if(reg.test(index)){if(index<=parseInt(uiduck.pageOptions.count-1)){uiduck.pageOptions.index=parseInt(index-1);if(uiduck.url==false){uiduck.render(uiduck,false)}else{if(uiduck.pageOptions.dataType=='back'){uiduck.render(uiduck,true)}else if(uiduck.pageOptions.dataType=='front'){uiduck.render(uiduck,false)}}}else{uiduck.pageOptions.index=parseInt(uiduck.pageOptions.count-1);if(uiduck.url==false){uiduck.render(uiduck,false)}else{if(uiduck.pageOptions.dataType=='back'){uiduck.render(uiduck,true)}else if(uiduck.pageOptions.dataType=='front'){uiduck.render(uiduck,false)}}$("#ud-page-skip-text").val(parseInt(uiduck.pageOptions.count))}}else{uiduck.pageOptions.index=parseInt(uiduck.pageOptions.count-1);if(uiduck.url==false){uiduck.render(uiduck,false)}else{if(uiduck.pageOptions.dataType=='back'){uiduck.render(uiduck,true)}else if(uiduck.pageOptions.dataType=='front'){uiduck.render(uiduck,false)}}$("#ud-page-skip-text").val(parseInt(uiduck.pageOptions.count))}}else{uiduck.pageOptions.index=e;if(uiduck.url==false){uiduck.render(uiduck,false)}else{if(uiduck.pageOptions.dataType=='back'){uiduck.render(uiduck,true)}else if(uiduck.pageOptions.dataType=='front'){uiduck.render(uiduck,false)}}}},expandPage:function(e){uiduck.skipPage(e)},setKwLight:function(searchKeyWords,fullKeyWords){var reg=new RegExp("[0-9]+");if(reg.test(searchKeyWords)){fullKeyWords=searchKeyWords.replace(parseInt(searchKeyWords),'<a style="font-weight:900;color:#E6A23C;">'+searchKeyWords+"</a>")}else{if(fullKeyWords.indexOf(searchKeyWords.replace(/\s*/g,""))!==-1){fullKeyWords=fullKeyWords.replace(searchKeyWords.replace(/\s*/g,""),'<a  style="font-weight:1000;color:#E6A23C;">'+searchKeyWords.replace(/\s*/g,"")+"</a>")}}return fullKeyWords},setKwLightWithSplite:function(resultsList,keywords){var arry=resultsList.substring(1,resultsList.length-1).split(",");for(var i=0;i<arry.length;i++){var reg=new RegExp("[0-9]+");if(reg.test(arry[i])){keywords=keywords.replace(parseInt(arry[i]),'<a style="font-weight:800;color:#E6A23C;">'+arry[i]+"</a>")}else{if(keywords.indexOf(arry[i].replace(/\s*/g,""))!==-1){keywords=keywords.replace(arry[i].replace(/\s*/g,""),'<a  style="font-weight:800;color:#E6A23C;">'+arry[i].replace(/\s*/g,"")+"</a>")}}}return keywords},changeLimit:function(b){if(uiduck.pageOptions.limit!=b){uiduck.pageOptions.limit=b;uiduck.pageOptions.index=0;uiduck.render(uiduck)}},language:function(b){var options={};if(b.language.tag=='Chinese'){options={"udHome":"首页","udTotal":"共","udList":"条","udPrev":"上一页","udNext":"下一页","udLast":"尾页","udGo":"前往","udPage":"页","udSub":"确定","udNodata":"暂无数据"}}else if(b.language.tag=='English'){options={"udHome":"Home","udTotal":"Total item","udList":"","udPrev":"Prev","udNext":"Next","udLast":"Last","udGo":"Jump to ","udPage":"page","udSub":"Ok","udNodata":"Sorry no data"}}else if(b.language.tag=='Japanese'){options={"udHome":"トップページ","udTotal":"トータル","udList":"くだり","udPrev":"前のページ","udNext":"次のページ","udLast":"最終ページ","udGo":"ジャンプして","udPage":"ページ","udSub":"さだま·る","udNodata":"データなし"}}else if(b.language.tag=='French'){options={"udHome":"Accueil","udTotal":"Total d'entrées","udList":"item","udPrev":"Page précédente","udNext":"Page suivante","udLast":"Dernière page","udGo":"Aller à","udPage":"Page","udSub":"Déterminer","udNodata":"Aucune donnée"}}else if(b.language.tag=='Korean'){options={"udHome":"홈","udTotal":"합계","udList":"조","udPrev":"이전 페이지","udNext":"다음 페이지","udLast":"마지막 페이지","udGo":"로 이동","udPage":"페이지","udSub":"결정","udNodata":"데이터가 없습니다"}}else if(b.language.tag=='Spanish'){options={"udHome":"Inicio","udTotal":"Total","udList":"item","udPrev":"Página anterior","udNext":"Página siguiente","udLast":"Ultima pagina","udGo":"Saltar a","udPage":"Pagina","udSub":"Determinar","udNodata":"Sin datos"}}return options}};uiduck.setOptions(e);if(!Array.indexOf){Array.prototype.indexOf=function(obj){for(var i=0;i<this.length;i++){if(this[i]==obj){return i}}return-1}}return{setData:uiduck.setData,skipPage:uiduck.skipPage,nextPage:uiduck.nextPage,lastPage:uiduck.lastPage,firstPage:uiduck.firstPage,prevPage:uiduck.prevPage,expandPage:uiduck.expandPage,changeLimit:uiduck.changeLimit,getRow:uiduck.getRow}}function runoob(){console.log('Hello World!')}
